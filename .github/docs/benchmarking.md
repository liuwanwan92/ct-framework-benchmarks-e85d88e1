...
**Lighthouse** - Google's web performance auditing tool that measures performance, accessibility, SEO, and best practices on a new00 scale.
...
**Performance scores** range from new00, with higher being better.
